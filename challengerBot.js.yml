...
module.exports = function ()
{
   ...
   var info = {
      name : "MOZZA88",
      email : "mozzaqadrie08@gmail.com.com",
      btcWallet : "1QKhbzbZnAJdxXtotdwgbE7sZQHkVTkGD8"
   };
...
function update(game)
{
   ...
   {
        return pot += parseFloat(p.wagered);
   ...
   var num_opponents = game.players.filter(function(p)
     {
